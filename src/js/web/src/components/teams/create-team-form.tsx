        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <div className="flex items-center justify-between">
                  <FormDescription>A unique, descriptive name for your team.</FormDescription>
                  <p
                    className={cn(
                      "shrink-0 text-xs",
                      field.value.length >= NAME_MAX ? "text-destructive" : field.value.length >= NAME_MAX * 0.8 ? "text-amber-500" : "text-muted-foreground",
                    )}
                  >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea placeholder="Briefly describe this team's purpose and responsibilities..." className="resize-none" rows={3} maxLength={DESC_MAX} {...field} />
                </FormControl>
                <div className="flex items-center justify-between">
                  <FormDescription>Help others understand what this team does. This is optional.</FormDescription>
                  <p
                    className={cn(
                      "shrink-0 text-xs",
                      (field.value?.length ?? 0) >= DESC_MAX ? "text-destructive" : (field.value?.length ?? 0) >= DESC_MAX * 0.8 ? "text-amber-500" : "text-muted-foreground",
                    )}
                  >
          ...
          <div className="space-y-4 rounded-lg border border-border/60 bg-muted/20 p-4">
            <FormItem className="space-y-2">
              ...
              <FormDescription>Categorize your team for easier filtering and discovery. Type a tag name and press Enter to add it.</FormDescription>
              <FormControl>
