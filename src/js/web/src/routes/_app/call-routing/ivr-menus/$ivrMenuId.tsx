...
function parseDestination(raw: string): { type: DestinationType; value: string } {
  ...
  // Map known prefixes to canonical destination types
...
function DestinationPicker({ value, onChange, label, placeholder }: { value: string; onChange: (dest: string) => void; label?: string; placeholder?: string }) {
