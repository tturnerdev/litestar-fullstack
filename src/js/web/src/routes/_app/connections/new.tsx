                    ...
                    <div className="space-y-4 rounded-lg border border-border/60 bg-muted/20 p-4">
                      ...
                      <div className="flex items-start gap-2 rounded-md bg-muted/40 px-3 py-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Credentials are encrypted at rest and never displayed after saving. Only authorized team members can update them.
                        </p>
                      </div>
        ...
        <AlertDialog open={pendingAuthType !== null} onOpenChange={(open) => !open && cancelAuthTypeChange()}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>Switching the authentication type will clear all credential fields you have filled in. This cannot be undone.</AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
