    ...
    <PageContainer className="flex-1 space-y-8">
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem
                  onClick={() => {
                    ...
                    toast.success("Copied registration ID")
                  }}
                >
                ...
                {data.phoneNumberId ? (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="truncate text-sm font-medium group-hover:text-primary">{data.phoneNumberDisplay ?? data.phoneNumberLabel ?? data.phoneNumberId.slice(0, 8)}</p>
                    </div>
      ...
      <PageSection delay={0.4}>
        <SectionErrorBoundary name="Activity">
          <EntityActivityPanel targetType="e911_registration" targetId={registrationId} />
        </SectionErrorBoundary>
      </PageSection>
    </PageContainer>
  )
