          ...
          breadcrumbs={
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink asChild>
                    <Link to="/fax/numbers">Fax Numbers</Link>
                  </BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>New Number</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          }
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  {errors.number ? (
                    ...
                    <p className="text-xs text-muted-foreground">Enter the full phone number including country code.</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-xs text-muted-foreground">An optional friendly name to identify this number.</p>
                    <p
                      className={cn(
                        "shrink-0 text-xs",
                        label.length >= LABEL_MAX ? "text-destructive" : label.length >= LABEL_MAX * 0.8 ? "text-amber-500" : "text-muted-foreground",
                      )}
                    >
