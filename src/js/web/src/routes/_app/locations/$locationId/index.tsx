...
function buildGoogleMapsUrl(location: Location): string | null {
  const parts = [location.addressLine1, location.addressLine2, location.city, location.state, location.postalCode, location.country].filter(Boolean)
              ...
              <Card className="border-border/60 bg-card/80 shadow-md shadow-primary/10">
                ...
                <CardContent>
                  {devicesLoading ? (
                    ...
                    <EmptyState icon={Cpu} title="No devices at this location" description="Devices assigned to this location will appear here." />
                  )}
                </CardContent>
              </Card>
            </SectionErrorBoundary>
              ...
              <Card className="border-border/60 bg-card/80 shadow-md shadow-primary/10">
                ...
                <CardContent>
                  {e911Loading ? (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground line-clamp-1">{[reg.addressLine1, reg.city, reg.state, reg.postalCode].filter(Boolean).join(", ")}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                            <Badge variant={reg.validated ? "default" : "outline"} className={reg.validated ? "bg-emerald-600 text-white text-xs" : "text-xs"}>
                    ...
                    <EmptyState icon={Shield} title="No E911 registrations" description="E911 registrations linked to this location will appear here." />
                  )}
                </CardContent>
              </Card>
            </SectionErrorBoundary>
                ...
                <CardContent className="space-y-4">
                  ...
                  {data.parentId && (
                    <div className="space-y-1">
                      ...
                      <Link to="/locations/$locationId" params={{ locationId: data.parentId }} className="text-sm text-primary hover:underline">
