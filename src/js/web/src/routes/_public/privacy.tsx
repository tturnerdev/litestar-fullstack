        ...
        <div className="w-full max-w-xl space-y-8">
          ...
          <div className="space-y-6 text-muted-foreground">
            <motion.div className="space-y-2" custom={3} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="data-collected" className="scroll-mt-20 text-lg font-semibold text-foreground">
                1. Data Collected
              </h3>
            ...
            <motion.div className="space-y-2" custom={4} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="retention" className="scroll-mt-20 text-lg font-semibold text-foreground">
                2. Retention
              </h3>
            ...
            <motion.div className="space-y-2" custom={5} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="third-parties" className="scroll-mt-20 text-lg font-semibold text-foreground">
                3. Third Parties
              </h3>
            ...
            <motion.div className="space-y-2" custom={6} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="your-rights" className="scroll-mt-20 text-lg font-semibold text-foreground">
                4. Your Rights
              </h3>
              <p>
                You may request access to, correction of, or deletion of your personal data at any time by contacting support. We will respond to verified requests within 30 days.
                Where applicable, you also have the right to data portability and to restrict or object to certain processing activities.
              </p>
            </motion.div>

            <motion.div className="space-y-2" custom={7} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="cookies" className="scroll-mt-20 text-lg font-semibold text-foreground">
                5. Cookies
              </h3>
              <p>
                This application uses session cookies solely for authentication and maintaining your login state. We do not use tracking cookies, advertising cookies, or any
                third-party analytics cookies. Session cookies expire when you log out or after a period of inactivity.
              </p>
            </motion.div>

            <motion.div className="space-y-2" custom={8} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="updates-to-this-policy" className="scroll-mt-20 text-lg font-semibold text-foreground">
                6. Updates to This Policy
              </h3>
              <p>
                We may update this privacy policy from time to time to reflect changes in our practices or for operational, legal, or regulatory reasons. When we make material
                changes, we will notify you through the application or via email. We encourage you to review this page periodically.
              </p>
            </motion.div>
          </div>
