    ...
    <div className="relative flex min-h-screen w-full">
      ...
      <div className="flex flex-1 flex-col items-center bg-brand-gray-light px-4 py-12 dark:bg-background">
        <div className="w-full max-w-xl space-y-8">
          {/* Top bar */}
          <motion.div className="flex items-center justify-between" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
            <div />
          ...
          {/* Table of contents */}
          <motion.nav className="rounded-lg border border-border/60 bg-muted/40 p-4" custom={1} variants={fadeIn} initial="hidden" animate="visible">
          ...
          <div className="space-y-6 text-muted-foreground">
            <motion.div className="space-y-2" custom={3} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="usage" className="scroll-mt-20 text-lg font-semibold text-foreground">
                1. Usage
              </h3>
            ...
            <motion.div className="space-y-2" custom={4} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="data" className="scroll-mt-20 text-lg font-semibold text-foreground">
                2. Data
              </h3>
            ...
            <motion.div className="space-y-2" custom={5} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="support" className="scroll-mt-20 text-lg font-semibold text-foreground">
                3. Support
              </h3>
            ...
            <motion.div className="space-y-2" custom={6} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="account-responsibilities" className="scroll-mt-20 text-lg font-semibold text-foreground">
                4. Account Responsibilities
              </h3>
              <p>
                You are responsible for maintaining the confidentiality of your account credentials, including passwords and multi-factor authentication tokens. You agree to notify
                us immediately of any unauthorized use of your account. We are not liable for losses arising from unauthorized access resulting from your failure to safeguard your
                credentials.
              </p>
            </motion.div>

            <motion.div className="space-y-2" custom={7} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="intellectual-property" className="scroll-mt-20 text-lg font-semibold text-foreground">
                5. Intellectual Property
              </h3>
              <p>
                All content, trademarks, and software associated with this application are owned by or licensed to us. You retain ownership of any data you submit. By using the
                service, you grant us a limited license to process your data solely for the purpose of providing the service.
              </p>
            </motion.div>

            <motion.div className="space-y-2" custom={8} variants={fadeIn} initial="hidden" animate="visible">
              <h3 id="changes-to-terms" className="scroll-mt-20 text-lg font-semibold text-foreground">
                6. Changes to Terms
              </h3>
              <p>
                We reserve the right to modify these terms at any time. When changes are material, we will provide notice through the application or by email at least 14 days
                before the new terms take effect. Your continued use of the service after changes become effective constitutes acceptance of the revised terms.
              </p>
            </motion.div>
          </div>

          {/* Cross-link footer */}
          <motion.div className="border-t border-border/60 pt-6 text-center" custom={9} variants={fadeIn} initial="hidden" animate="visible">
      ...
      <AnimatePresence>
        {showTop && (
          ...
          >
            <Button size="icon" variant="outline" className="h-10 w-10 rounded-full shadow-lg" onClick={scrollToTop} aria-label="Back to top">
