...
class AdminTeamsController(Controller):
    ...
    @get(operation_id="AdminListTeams", summary="List teams (admin)", path="/")
    ...
    @get(operation_id="AdminGetTeam", summary="Get team details (admin)", path="/{team_id:uuid}")
    async def get_team(
        self,
        teams_service: TeamService,
        team_id: UUID,
    ...
    @patch(operation_id="AdminUpdateTeam", summary="Update a team (admin)", path="/{team_id:uuid}")
