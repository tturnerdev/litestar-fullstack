...
class LocationCreate(CamelizedBaseStruct):
    ...
    parent_id: UUID | None = None
    address_line_1: Annotated[str, Meta(min_length=1, max_length=255)] | None = None
    address_line_2: Annotated[str, Meta(min_length=1, max_length=255)] | None = None
    city: Annotated[str, Meta(min_length=1, max_length=100)] | None = None
    state: Annotated[str, Meta(min_length=1, max_length=100)] | None = None
    postal_code: Annotated[str, Meta(min_length=1, max_length=20)] | None = None
    country: Annotated[str, Meta(min_length=1, max_length=100)] | None = None
