            ...
            queue_configs=[
                QueueConfig(
                    ...
                    tasks=[
                        ...
                        device_jobs.device_status_sync_job,
                    ...
                    scheduled_tasks=[
                        ...
                        CronJob(
                            function=device_jobs.device_status_sync_job,
                            cron="*/5 * * * *",
                            timeout=120,
                            ttl=600,
                        ),
...
class Settings:
    ...
    def from_env(cls, dotenv_filename: str = ".env") -> Settings:
        ...
        try:
            ...
            sys.exit(1)
        return Settings(app=app, db=db, vite=vite, server=server, saq=saq, log=log, gateway=gateway, storage=storage)
