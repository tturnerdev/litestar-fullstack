"""Tests for schedule domain guards."""
...
class TestRequiresScheduleTeamMembership:
    def test_no_team_id_passes(self) -> None:
        connection = _make_connection()
        requires_schedule_team_membership(connection, Mock())
